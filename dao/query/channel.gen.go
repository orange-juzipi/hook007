...
func newChannel(db *gorm.DB, opts ...gen.DOOption) channel {
	...
	_channel.channelDo.UseModel(&model_gen.Channel{})
	...
	_channel.Configration = field.NewString(tableName, "configration")
...
func (c *channel) updateTableName(table string) *channel {
	...
	c.Configration = field.NewString(table, "configration")
...
func (c *channel) fillFieldMap() {
	...
	c.fieldMap["configration"] = c.Configration
}
...
func (c channelDo) Create(values ...*model_gen.Channel) error {
	if len(values) == 0 {
		return nil
	}
...
func (c channelDo) CreateInBatches(values []*model_gen.Channel, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c channelDo) Save(values ...*model_gen.Channel) error {
	if len(values) == 0 {
		return nil
	}
...
func (c channelDo) First() (*model_gen.Channel, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_gen.Channel), nil
	}
}

func (c channelDo) Take() (*model_gen.Channel, error) {
...
func (c channelDo) Last() (*model_gen.Channel, error) {
...
func (c channelDo) Find() ([]*model_gen.Channel, error) {
	result, err := c.DO.Find()
	return result.([]*model_gen.Channel), err
}

func (c channelDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.Channel, err error) {
	buf := make([]*model_gen.Channel, 0, batchSize)
...
func (c channelDo) FindInBatches(result *[]*model_gen.Channel, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c channelDo) FirstOrInit() (*model_gen.Channel, error) {
...
func (c channelDo) FirstOrCreate() (*model_gen.Channel, error) {
...
func (c channelDo) FindByPage(offset int, limit int) (result []*model_gen.Channel, count int64, err error) {
...
func (c channelDo) Delete(models ...*model_gen.Channel) (result gen.ResultInfo, err error) {
