...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&model_gen.User{})
	...
	_user.SecretKey = field.NewString(tableName, "secret_key")
...
func (u *user) updateTableName(table string) *user {
	...
	u.SecretKey = field.NewString(table, "secret_key")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["secret_key"] = u.SecretKey
}
...
func (u userDo) Create(values ...*model_gen.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*model_gen.User, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*model_gen.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*model_gen.User, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_gen.User), nil
	}
}

func (u userDo) Take() (*model_gen.User, error) {
...
func (u userDo) Last() (*model_gen.User, error) {
...
func (u userDo) Find() ([]*model_gen.User, error) {
	result, err := u.DO.Find()
	return result.([]*model_gen.User), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_gen.User, err error) {
	buf := make([]*model_gen.User, 0, batchSize)
...
func (u userDo) FindInBatches(result *[]*model_gen.User, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*model_gen.User, error) {
...
func (u userDo) FirstOrCreate() (*model_gen.User, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*model_gen.User, count int64, err error) {
...
func (u userDo) Delete(models ...*model_gen.User) (result gen.ResultInfo, err error) {
